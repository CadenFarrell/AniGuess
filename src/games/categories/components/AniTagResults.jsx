import { Backdrop, Badge, Button, Card, CardRow, Screen, Wordmark } from '../../../shared/ui';
...
export default function AniTagResults({
  ...
  return (
    <>
      {/* Every other AniTag screen has one — setup, the session and the lobby —
          so a results screen without it ends the game on a flat background that
          reads as a different app. anirank's results screen is the precedent. */}
      <Backdrop />
      <Screen>
        <Wordmark tone="lime" size="md" className="mb-8">Final scores</Wordmark>
